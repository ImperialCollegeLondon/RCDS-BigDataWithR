...
```{r load data with data frame}
# use read.csv() and Sys.time() to check the loading time
# for example
starting <- Sys.time()
compustat <- read.csv("computstat_gbr_2014_2024.csv")
Sys.time() - starting
```

```{r load data with data table}

# use fread() and Sys.time() to observe the loading time
starting <- Sys.time()
compustat <- fread("computstat_gbr_2014_2024.csv")
Sys.time() - starting
```
